# ABOUTME: Shared org-mode play parser — line-by-line state machine emitting typed events.
# ABOUTME: Handles Unicode character names, direction normalisation, and :noexport: sections.
package OrgPlay::Parser;
...
sub _parse_character_line {
    ...
    # Name: capitalised words (ALL CAPS or Title Case). Direction: lowercase-initial or punctuation.
